...
export const CATEGORIES = [
  ...
  },
  {
    ...
    title: 'Cek Harian Larva', frekuensi: 'Harian, per tank',
    desc: 'Observasi mutu larva: perkembangan stadia, mortalitas/abnormalitas, molting, parasit, kondisi usus, dan transfer.',
    chart: ['mortalitas', 'problemMolting'],
    fields: [
      { key: 'tanggal', label: 'Tanggal', type: 'date', required: true },
      { key: 'tankId', label: 'Tank', type: 'ref', refCollection: 'tank', refLabelKey: 'namaTank' },
      { key: 'stadiaDominan', label: 'Stadia Dominan', type: 'select', options: STAGES },
      { key: 'doc', label: 'Umur (DOC)', type: 'number', unit: 'hari' },
      { key: 'mortalitas', label: 'Mortalitas', type: 'number', unit: '%', group: 'Abnormalitas', threshold: { safeMax: 5, dangerMax: 15 } },
      { key: 'abnormal', label: 'Abnormal', type: 'number', unit: '%', group: 'Abnormalitas', threshold: { safeMax: 5, dangerMax: 15 } },
      { key: 'nekrosis', label: 'Nekrosis', type: 'number', unit: '%', group: 'Abnormalitas', threshold: { safeMax: 3, dangerMax: 10 } },
      { key: 'kanibalisme', label: 'Kanibalisme', type: 'number', unit: '%', group: 'Abnormalitas', threshold: { safeMax: 3, dangerMax: 10 } },
      { key: 'problemMolting', label: 'Problem Molting', type: 'number', unit: '%', group: 'Abnormalitas', threshold: { safeMax: 5, dangerMax: 15 } },
      { key: 'protozoa', label: 'Protozoa', type: 'select', options: ['Tidak ada', 'Sedikit', 'Banyak'], group: 'Parasit', threshold: { badValues: ['Banyak'], warnValues: ['Sedikit'] } },
      { key: 'zoothamnium', label: 'Zoothamnium', type: 'select', options: ['Tidak ada', 'Sedikit', 'Banyak'], group: 'Parasit', threshold: { badValues: ['Banyak'], warnValues: ['Sedikit'] } },
      { key: 'vorticella', label: 'Vorticella', type: 'select', options: ['Tidak ada', 'Sedikit', 'Banyak'], group: 'Parasit', threshold: { badValues: ['Banyak'], warnValues: ['Sedikit'] } },
      { key: 'filamen', label: 'Filamen (air & body)', type: 'select', options: ['Tidak ada', 'Sedikit', 'Banyak'], group: 'Parasit' },
      { key: 'sisaAlgae', label: 'Sisa Algae', type: 'select', options: ['Bersih', 'Sedikit', 'Banyak'], help: 'Pengecekan sisa algae (N5/Z1–M2/M3)' },
      { key: 'kondisiUsus', label: 'Kondisi Usus (penuh)', type: 'number', unit: '%', threshold: { safeMin: 80, dangerMin: 50 }, help: 'Skor usus 0 / ½ → % sampel usus penuh' },
      { key: 'hasilMikro', label: 'Hasil Mikro (Vibrio)', type: 'select', options: ADA, threshold: { badValues: ['Ada'] } },
      { key: 'transferStadia', label: 'Transfer (stadia)', type: 'select', options: STAGES, group: 'Transfer PL' },
      { key: 'transferSR', label: 'Survival Rate (SR)', type: 'number', unit: '%', group: 'Transfer PL', threshold: { safeMin: 80, dangerMin: 60 } },
      { key: 'transferSize', label: 'Size', type: 'number', unit: 'ekor/g', group: 'Transfer PL' },
      { key: 'catatan', label: 'Catatan', type: 'textarea' },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'fertil', label: 'Fertil', type: 'number', unit: '%', group: 'Pemijahan', threshold: { safeMin: 80, dangerMin: 60 } },
      { key: 'hatching', label: 'Hatching', type: 'number', unit: '%', group: 'Pemijahan', threshold: { safeMin: 70, dangerMin: 50 } },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'pakan', label: 'Pakan', type: 'text' },
      { key: 'catatan', label: 'Catatan', type: 'textarea' },
    ],
  },
  {
    ...
    desc: 'Ukuran & keseragaman PL, serta data panen dan pengiriman.',
    chart: ['cv', 'panjangRata'],
    fields: [
      { key: 'tanggal', label: 'Tanggal', type: 'date', required: true },
      { key: 'tankId', label: 'Tank', type: 'ref', refCollection: 'tank', refLabelKey: 'namaTank' },
      { key: 'stadia', label: 'Stadia', type: 'select', options: STAGES },
      { key: 'panjangRata', label: 'Panjang Rata-rata', type: 'number', unit: 'mm', group: 'Ukuran' },
      { key: 'ekorPerGram', label: 'Ekor per Gram', type: 'number', unit: 'ekor/g', group: 'Ukuran' },
      { key: 'cv', label: 'CV Ukuran', type: 'number', unit: '%', group: 'Ukuran', threshold: { safeMax: 10, dangerMax: 20 } },
      { key: 'stressSurvival', label: 'Stress Test Survival', type: 'number', unit: '%', threshold: { safeMin: 90, dangerMin: 80 } },
      { key: 'jumlahPL', label: 'Jumlah PL', type: 'number', unit: 'ekor', group: 'Panen' },
